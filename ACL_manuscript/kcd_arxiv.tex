...
\author{
  Anonymous Authors\thanks{Code, data, and experiment logs: \url{https://github.com/SteveMama/rt-geometry-memory}.} \\
...
\emph{Right}: KCD signal variants ($n{=}1{,}000$ conv). Sem-QCG achieves
$705.5$ at $B{=}0.50$---below the uniform baseline of $761.6$ (dotted line).}
\label{fig:logit_l2}
\end{figure}
...
all budgets among KCD variants on MSC ($n{=}1{,}000$ conv), confirming that
...
The NLL advantage grows with model scale
...
% ---------------------------------------------------------------
Experiments were conducted on cloud GPU infrastructure.
Code, data, and experiment logs are available at \url{https://github.com/SteveMama/rt-geometry-memory}.
...
1{,}000 conversations for signal variant study (full validation split).
