# Paper 3 Memory-Critical Analysis: qwen25_15b | geometry_segment_actions @ budget 0.35
...
- stress_retrieval_launch_packet t2 (retrieval_heavy, target t5): support constraint, delta logit L2 -30.039, compressed segments 0
...
- stress_code_sql_query t2 (code_conversation, target t5): support constraint, delta logit L2 30.020, compressed segments 0
  content: Also require only paid orders and return u.id plus o.paid_at, ordered by newest paid_at first.
- stress_code_python_function t2 (code_conversation, target t5): support constraint, delta logit L2 45.102, compressed segments 0
