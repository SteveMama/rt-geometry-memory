# Paper 3 Memory-Critical Analysis: qwen25_3b | geometry_segment_actions @ budget 0.35
...
- stress_code_sql_query t2 (code_conversation, target t5): support constraint, delta logit L2 31.580, compressed segments 0
  content: Also require only paid orders and return u.id plus o.paid_at, ordered by newest paid_at first.
- stress_code_python_function t2 (code_conversation, target t5): support constraint, delta logit L2 39.001, compressed segments 0
