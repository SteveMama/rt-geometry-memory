# Paper 3 Memory-Critical Analysis: smollm2_17b | geometry_keep_compress_drop @ budget 0.35
...
- Cases compared: 36
- geometry_keep_compress_drop retains more support user turns than uniform: 6 cases
- Uniform retains more support user turns than geometry_keep_compress_drop: 8 cases
- Ties: 22
- geometry_keep_compress_drop keeps the latest support turn while uniform drops it: 6 cases
- Cases with nonzero compressed segments: 29
- Compressed cases that are not worse than uniform on support retention: 21

## Rescued Support Types

- support constraint: 3
- base memory: 3
